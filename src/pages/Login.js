					...
					<div class='w-full bg-white rounded-lg shadowr md:mt-0 sm:max-w-md xl:p-0'>
						<div class='p-6 space-y-4 md:space-y-6 sm:p-8'>
							...
							<form class='space-y-4 md:space-y-6' action='#'>
								...
								<button
									type='submit'
									class='w-full text-white bg-[#FF504E] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center'>
									Log in
								</button>
							</form>
						</div>
